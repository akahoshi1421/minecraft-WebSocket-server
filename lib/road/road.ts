...
class Road extends Block{
    ...
    road(scale: number){
        ...
        facet normal  1.000000e+01  0.000000e+00  0.000000e+01
            outer loop
                vertex  ${Number(`${this.x+1}.000000e+01`) * scale}  ${Number(`${this.y}.937500e+01`) * scale}  ${Number(`${this.z}.000000e+01`) * scale}
        ...
        facet normal  1.000000e+01  0.000000e+00  0.000000e+01
            outer loop
                ...
                vertex  ${Number(`${this.x+1}.000000e+01`) * scale}  ${Number(`${this.y}.937500e+01`) * scale}  ${Number(`${this.z+1}.000000e+01`) * scale}
        ...
        facet normal  0.000000e+00  0.000000e+00  -1.000000e+01
            outer loop
                ...
                vertex  ${Number(`${this.x}.000000e+01`) * scale}  ${Number(`${this.y}.937500e+01`) * scale}  ${Number(`${this.z}.000000e+01`) * scale}

            endloop
        endfacet
        facet normal  0.000000e+00  0.000000e+00  -1.000000e+01
            outer loop
                vertex  ${Number(`${this.x}.000000e+01`) * scale}  ${Number(`${this.y}.937500e+01`) * scale}  ${Number(`${this.z+1}.000000e+01`) * scale}
