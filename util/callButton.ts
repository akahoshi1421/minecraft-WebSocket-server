...
const callButton = (id: number, x: number, y: number, z: number, scale: number) => {
    ...
    switch(idNum1){
        case BUTTON:
            ...
            if(xButtonId === 1) return xButton.xMinus(scale);
            else if(xButtonId === 2) return xButton.xPlus(scale);
        ...
        case BUTTON + 0.1:
            ...
            if(yButtonId === 1) return yButton.yMinus(scale);
            else if(yButtonId === 2) return yButton.yPlus(scale);
        ...
        case BUTTON + 0.2:
            ...
            if(zButtonId === 1) return zButton.zMinus(scale);
            else if(zButtonId === 2) return zButton.zPlus(scale);
